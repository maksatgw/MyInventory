...
namespace MyInventory.Application.Concrete
{
    public class EquipmentImageService : IEquipmentImageService
    {
        ...
        public EquipmentImageService(IEquipmentImageDataAccess dataAccess)
        {
            _dataAccess = dataAccess;
        }

        public async Task TDelete(EquipmentImage model)
        {
            try
            {
        ...
        public async Task<EquipmentImage> TGet(int id)
        {
            try
            {
        ...
        public async Task<List<EquipmentImage>> TGet()
        {
            try
            {
        ...
        public async Task TInsert(EquipmentImage model)
        {
            try
            {
        ...
        public async Task TUpdate(EquipmentImage model)
        {
            try
            {
